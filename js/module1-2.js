...
//if (currentPrice >= minPrice && currentPrice <= maxPrice) {
    //console.log("Этот товар я покупаю")
//} else {console.log("no")}
 
//||
//console.log(0 || NaN || true || false)
//!
...
/*let a = prompt("Давай первое число");
a = Number(a);
console.log(a);
let b = prompt("Давай второе число");
b = Number(b);
console.log(b);
const result = a * b;
console.log(result);*/
...
for (let i = 1; i <= employees; i += 1) {
  ...
  console.log(`Зарплата работника ${i} составила ${salary} грюнделей`);
  totalSalary += salary;
  
}
console.log(`Общая зарплата составила ${totalSalary} грюнделей`);*/
